...
int mandelbrot_tile(const Fractal* fractal, size_t startX, size_t startY, size_t tileWidth, size_t tileHeight, size_t* iterBuffer, size_t imageWidth, size_t imageHeight);
